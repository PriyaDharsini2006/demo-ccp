                ...
                {innovations.length === 0 ? (
                  ...
                  innovations.map((innovation) => (
                    <tr key={innovation.id}>
                      <td className="p-2 border bg-black">
                        {innovation.title}
                      </td>
                      ...
                      <td className="p-2 border">
                        {innovation.fundingDetails || "Not specified"}
                      </td>
                      <td className="p-2 border">
                        <button
                ...
                {researches.length === 0 ? (
                  ...
                  researches.map((research) => (
                    <tr key={research.id}>
                      ...
                      <td className="p-2 border">
                        {research.description.substring(0, 50)}...
                      </td>
                      <td className="p-2 border">
                        {research.researcher.fullName}
                      </td>
                      <td className="p-2 border">
                        <span
                          className={`px-2 py-1 rounded-full text-xs 
                ...
                {startups.length === 0 ? (
                  ...
                  startups.map((startup) => (
                    <tr key={startup.id}>
                      ...
                      <td className="p-2 border">
                        {startup.description
                          ? startup.description.substring(0, 50) + "..."
                          : "No description"}
                      </td>
                      ...
                      <td className="p-2 border">
                        {startup.fundingDetails || "Not specified"}
                      </td>
                      <td className="p-2 border">
                        <button
                          className="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600"
          ...
          <div className="bg-black p-6 rounded-lg w-full max-w-md">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">
                By{" "}
                {currentItem.type === "innovation"
                  ? currentItem.innovator.fullName
                  : currentItem.type === "research"
                    ? currentItem.researcher.fullName
